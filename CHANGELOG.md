...
If you run Forvia for other people, you have had no way to answer "who signed in, and when?" —
...
And the project has a working home again: Forvia now lives on **GitLab**, where CI builds the
...
- ▶️ **<https://forvia.duarte-santos.ch/demo/>** — the in-browser demo, running on the project's
...
### Forvia moved to GitLab

- 🏠 **<https://gitlab.com/DuarteSantos8/forvia>** is the home of the project. Same history,
...
- 🐳 **Prebuilt images are back.** `docker compose pull` now fetches
  `registry.gitlab.com/duartesantos8/forvia/api` and `/web`, built for **amd64 and arm64** on
...
- 🌐 The in-browser demo also builds to GitLab Pages
  (<https://forvia-bc111a.gitlab.io/>, which <https://duartesantos8.gitlab.io/forvia/>
  redirects to); <https://forvia.duarte-santos.ch/demo/> remains the copy the landing page
  embeds.
...
A housekeeping release, and two things worth reading even if you skip the rest. Forvia has moved
...
- 🏠 **Forvia now lives at <https://gitea.com/DuarteSantos/Forvia>.** The GitHub account
  was suspended on 2026-08-19 and took the repository, the GHCR images, the Pages demo and
  Discussions with it. `docker compose` now pulls `gitea.com/duartesantos/forvia-{api,web}`; the
...
- ⚖️ **Forvia described the exercise dataset as "CC". That was wrong**, and it is now
...
- **Nothing changes for using Forvia.** It never shipped that media — not in the repository,
...
- **It does change what you may do with the media.** Reusing the images or animations — in
  Forvia or anywhere else, commercially or not — needs your own licence from Gym visual. See
  [NOTICE.md](NOTICE.md).
...
- 📊 **<https://forvia.duarte-santos.ch> now runs self-hosted, cookieless
...
- 🔒 **Your instance does not.** The frontend only gets an analytics tag when
  ...
  image or in a plain `npm run build`. A self-hosted Forvia remains telemetry-free, as advertised.
...
- **A per-muscle exercise breakdown** behind the muscle card — estimated 1RM per exercise, decay
  ...
  [#92](https://github.com/DuarteSantos8/Forvia/pull/92),
  [#93](https://github.com/DuarteSantos8/Forvia/pull/93) and
  [#94](https://github.com/DuarteSantos8/Forvia/pull/94).
- **Fatigue is now intensity-weighted**, not volume alone: a set counts for more the closer it is
  ...
  [#55](https://github.com/DuarteSantos8/Forvia/pull/55).
...
- 🔗 **Supersets advance properly.** Completing a set moves to the next member of the group, the
  ...
  [#80](https://github.com/DuarteSantos8/Forvia/pull/80).
- ➖ **Remove an exercise from a running session**, with a superset-aware picker and a confirmation.
  ...
  [#83](https://github.com/DuarteSantos8/Forvia/pull/83).
- ⬅️ **The Android back button closes the open sheet** instead of leaving the screen or the app
  ...
  Contributed by [@Space-Hermes](https://github.com/Space-Hermes) in
  [#85](https://github.com/DuarteSantos8/Forvia/pull/85).
...
- 🐳 **The API service no longer has to be called `api`** ([#99]). The web image builds its nginx
  ...
  [@GAS85](https://github.com/GAS85) in [#100](https://github.com/DuarteSantos8/Forvia/pull/100).
...
- 🏷️ **Health checks and OCI image labels** on both images — source, licence, version, revision and
  ...
  [@GAS85](https://github.com/GAS85) in [#98](https://github.com/DuarteSantos8/Forvia/pull/98).
...
[#63]: https://github.com/DuarteSantos8/Forvia/issues/63
[#87]: https://github.com/DuarteSantos8/Forvia/issues/87
[#99]: https://github.com/DuarteSantos8/Forvia/issues/99
...
Contributed by [@Space-Hermes](https://github.com/Space-Hermes) in
[#50](https://github.com/DuarteSantos8/Forvia/pull/50).
...
Contributed by [@Space-Hermes](https://github.com/Space-Hermes) in
[#64](https://github.com/DuarteSantos8/Forvia/pull/64).
...
Contributed by [@Space-Hermes](https://github.com/Space-Hermes) in
[#67](https://github.com/DuarteSantos8/Forvia/pull/67).
...
- 📥 **Imports mapped more of what other apps export** ([#74]). Treadmill, Goblet Squat, Cycling and
  ...
  overlap could reach the names Forvia stores them under. Those and their neighbours are now in
...
[#79]: https://github.com/DuarteSantos8/Forvia/issues/79
[#74]: https://github.com/DuarteSantos8/Forvia/issues/74
[#60]: https://github.com/DuarteSantos8/Forvia/pull/60
...
Forvia written by someone other than me. Thank you.
...
Forvia is also a standalone mobile app — and it ships as a direct APK download, not
through app stores.

- 📱 **Standalone mobile app.** The same frontend now also builds as a native iPhone /
  Android app (Capacitor) — the install-and-done flavor of Forvia: no account, no server,
...
- 🤖 **Android APK, no Play Store.** The official build is a signed, sideloadable APK
  (~4.5 MB) from [forvia.duarte-santos.ch](https://forvia.duarte-santos.ch) — deliberately
...
- ▶️ **Live demo** at [duartesantos8.github.io/Forvia](https://duartesantos8.github.io/Forvia/) —
...
- 🐳 Prebuilt Docker images published to `ghcr.io/duartesantos8/forvia-{api,web}` (amd64 + arm64)
