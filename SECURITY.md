...
Forvia is a self-hosted app: you run the server, you hold the data. This file says which
...
<https://gitlab.com/DuarteSantos8/forvia/-/issues/new> and tick **"This issue is confidential"**
...
> `github.com/DuarteSantos8/Forvia/security/advisories/new` no longer resolves.
...
- **The published images** `registry.gitlab.com/duartesantos8/forvia/api` and `/web`.
...
Read this before hosting Forvia for anyone other than yourself.
