...
// --- password login / demo data (added 2026-08-24) ---
  ...
  "Self-host openGym": "Развернуть openGym на своём сервере",
  "Sign in": "Войти",
  ...
  "Streak": "Серия",
  "This demo runs entirely in your browser on example data — nothing is sent anywhere. Account sign-in and sync across your devices come with the openGym server, which you get by self-hosting it.": "Эта демо-версия работает полностью в вашем браузере на примерных данных — никуда ничего не отправляется. Вход по аккаунту и синхронизация между устройствами доступны на сервере openGym, который вы получаете, развернув его самостоятельно.",
