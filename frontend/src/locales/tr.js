...
// --- password login / demo data (added 2026-08-24) ---
  ...
  "Streak": "Seri",
  "This demo runs entirely in your browser on example data — nothing is sent anywhere. Account sign-in and sync across your devices come with the openGym server, which you get by self-hosting it.": "Bu demo tamamen tarayıcında örnek verilerle çalışır — hiçbir yere hiçbir şey gönderilmez. Hesapla giriş ve cihazlar arası senkronizasyon, kendi barındırdığında elde ettiğin openGym sunucusuyla gelir.",
