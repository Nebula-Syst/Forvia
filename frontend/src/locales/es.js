...
export default {
  ...
  'Bio, badge color — perks that unlock with level': 'Bio, color de insignia — ventajas que se desbloquean al subir de nivel',
  '{0} locked': '{0} sin desbloquear',
...
// --- social posts: title, description, photos (added 2026-08-25) ---
  ...
  "Locked": "Bloqueado",
  "A \"veteran\" badge on your profile and the leaderboard.": "Una insignia de \"veterano\" en tu perfil y la clasificación.",
  "A custom color for your rank badge ring.": "Un color personalizado para el aro de tu insignia de rango.",
  "A golden badge frame and a highlighted name in comments and the leaderboard.": "Un marco dorado en la insignia y un nombre resaltado en comentarios y la clasificación.",
  "A small crown next to your name in the feed and leaderboard.": "Una pequeña corona junto a tu nombre en el feed y la clasificación.",
  "A special avatar frame — and 25% off the subscription, once it exists.": "Un marco de avatar especial — y un 25% de descuento en la suscripción, cuando exista.",
  "Add a short bio to your profile.": "Añade una bio corta a tu perfil.",
  "An animated glow around your profile card.": "Un brillo animado alrededor de tu tarjeta de perfil.",
  "An exclusive app-wide color theme.": "Un tema de color exclusivo para toda la app.",
  "Badge color": "Color de insignia",
  "Bio": "Bio",
  "Profile": "Perfil",
  "Unlocked by leveling up — see exactly what unlocks when on the Level page.": "Se desbloquea subiendo de nivel — mira exactamente qué se desbloquea y cuándo en la página de Nivel.",
  "Unlocks at Prestige {0}": "Se desbloquea en Prestigio {0}",
  "Unlocks at {0} (Level {1})": "Se desbloquea en {0} (Nivel {1})",
  "Unlocks at {0} (Level {1}) or Prestige {2}": "Se desbloquea en {0} (Nivel {1}) o Prestigio {2}",
  "Choose a custom color for your rank badge.": "Elige un color personalizado para tu insignia de rango.",
  "Perks": "Ventajas",
  ...
  "A special avatar frame.": "Un marco de avatar especial.",
  ...
  "The most exclusive, animated badge frame.": "El marco de insignia más exclusivo y animado de todos.",
  ...
  "The most exclusive, animated badge frame — and 50% off the subscription, once it exists.": "El marco de insignia más exclusivo y animado de todos — y un 50% de descuento en la suscripción, cuando exista.",
  ...
  "Veteran": "Veterano",
  "Your comments get a highlighted background.": "Tus comentarios llevan un fondo resaltado.",
  "Your name gets an animated color gradient in the feed.": "Tu nombre lleva un degradado de color animado en el feed.",
  "Your rank badge gets a subtle animated glow in the feed.": "Tu insignia de rango tiene un brillo animado sutil en el feed.",
}
