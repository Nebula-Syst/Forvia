...
export default {
  ...
  'to install Forvia as a full-screen app.': 'ile Forvia’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if Forvia is closed.': 'Forvia kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own Forvia — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Forvia\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
...
// --- password login / demo data (added 2026-08-24) ---
  "12 weeks of example workouts & weigh-ins, to see the app filled in": "Uygulamayı dolu görmek için 12 haftalık örnek antrenman ve kilo kaydı",
  "Account sign-in, sync across your devices, your own data.": "Hesapla giriş, cihazların arasında senkronizasyon, kendi verilerin.",
  "Activity": "Etkinlik",
  "Change username or password": "Kullanıcı adını veya şifreni değiştir",
  "Could not save": "Kaydedilemedi",
  "Create account": "Hesap oluştur",
  "Demo": "Demo",
  "Demo data loaded": "Demo verisi yüklendi",
  "Demo data reset": "Demo verisi sıfırlandı",
  "Enter your username and password": "Kullanıcı adını ve şifreni gir",
  "Example data, stored only in this browser — change anything you like.": "Örnek veriler, yalnızca bu tarayıcıda saklanır — istediğin gibi değiştir.",
  "Exercise": "Egzersiz",
  "Live demo — everything stays in this browser.": "Canlı demo — her şey bu tarayıcıda kalır.",
  "Load": "Yükle",
  "Load demo data": "Demo verisini yükle",
  "Load demo data?": "Demo verisi yüklensin mi?",
  "New password (min 8 characters)": "Yeni şifre (en az 8 karakter)",
  "No exercises yet.": "Henüz egzersiz yok.",
  "Password": "Şifre",
  "Password (min 8 characters)": "Şifre (en az 8 karakter)",
  "Password must be at least 8 characters": "Şifre en az 8 karakter olmalı",
  "Password updated": "Şifre güncellendi",
  "Puts the example plan, workouts and weigh-ins back the way they started.": "Örnek planı, antrenmanları ve kilo kayıtlarını başlangıçtaki haline döndürür.",
  "Replaces your current plan, workouts and body weight with a 12-week example history.": "Mevcut planını, antrenmanlarını ve kilonu 12 haftalık örnek bir geçmişle değiştirir.",
  "Reset": "Sıfırla",
  "Reset demo data": "Demo verisini sıfırla",
  "Reset demo data?": "Demo verisi sıfırlansın mı?",
  "Save changes": "Değişiklikleri kaydet",
  "Self-host it in a minute →": "Bir dakikada kendi sunucunda barındır →",
  "Self-host Forvia": "Forvia'i kendin barındır",
  "Sign in": "Giriş yap",
  "Signed in as {0} — data syncs to this profile.": "{0} olarak giriş yapıldı — veriler bu profille eşitlenir.",
  "Signs this profile out on every device, including this one. Sign in with your username and password again anytime.": "Bu profili, bu cihaz dahil tüm cihazlarda oturumdan çıkarır. İstediğin zaman kullanıcı adın ve şifrenle tekrar giriş yapabilirsin.",
  "Start the demo": "Demoyu başlat",
  "Streak": "Seri",
  "This demo runs entirely in your browser on example data — nothing is sent anywhere. Account sign-in and sync across your devices come with the Forvia server, which you get by self-hosting it.": "Bu demo tamamen tarayıcında örnek verilerle çalışır — hiçbir yere hiçbir şey gönderilmez. Hesapla giriş ve cihazlar arası senkronizasyon, kendi barındırdığında elde ettiğin Forvia sunucusuyla gelir.",
  "This week’s balance": "Bu haftanın dengesi",
  "Username": "Kullanıcı adı",
  "Username must be at least 3 characters": "Kullanıcı adı en az 3 karakter olmalı",
  "You’re in the demo": "Demodasın",
  "{0}/{1} this week": "Bu hafta {0}/{1}",
// --- social (added 2026-08-25) ---
  ...
  "Lets other accounts on this instance follow you and see your workouts in Social.": "Bu sunucudaki diğer hesapların seni takip etmesine ve Social'da antrenmanlarını görmesine izin verir.",
  "No activity yet — follow someone in Discover to see their workouts here.": "Henüz etkinlik yok — burada antrenmanlarını görmek için Keşfet'te birini takip et.",
  "No comments yet.": "Henüz yorum yok.",
  "Nobody on this instance has made their profile public yet.": "Bu sunucuda henüz kimse profilini herkese açık yapmadı.",
  "Post": "Gönder",
  "Progress": "İlerleme",
  "Public profile": "Herkese açık profil",
  "Resume workout": "Antrenmana devam et",
  "See what people you follow are training": "Takip ettiğin kişilerin neler çalıştığını gör",
  "Sign in to follow people and see their activity — guest profiles stay local to this device.": "Kişileri takip etmek ve etkinliklerini görmek için giriş yap — misafir profilleri yalnızca bu cihazda kalır.",
  "Social": "Social",
...
// --- social posts: title, description, photos (added 2026-08-25) ---
  "Add a description (optional)": "Açıklama ekle (isteğe bağlı)",
  "Copied to clipboard": "Panoya kopyalandı",
  "Could not copy": "Kopyalanamadı",
  "Could not upload image": "Görsel yüklenemedi",
  "Followers": "Takipçiler",
  "Name this workout": "Bu antrenmana bir isim ver",
  "Recent activity": "Son etkinlik",
  "Records": "Rekorlar",
  "Share": "Paylaş",
  "Show less": "Daha az göster",
  "Show {0} more exercises": "{0} egzersiz daha göster",
  "Suggested athletes": "Önerilen sporcular",
  "Title & photos": "Başlık ve fotoğraflar",
  "Previous": "Önceki",
  "For you": "Senin için",
  "View your profile": "Profilini görüntüle",
  "{0} is too large — max {1} MB": "{0} çok büyük — maks. {1} MB",
  "No public workouts yet.": "Henüz herkese açık antrenman yok.",
  "This profile isn't available.": "Bu profil kullanılamıyor.",
  "Level {0}": "Seviye {0}",
  "Today's tasks": "Bugünün görevleri",
  "Prestige {0}": "Prestij {0}",
  "Tiers": "Rütbeler",
  "{0} / {1} XP": "{0} / {1} XP",
  "{0} XP to next level": "Sonraki seviyeye {0} XP",
  "Rank": "Rütbe",
  "Prestige levels": "Prestij seviyeleri",
  "Locked": "Kilitli",
  "A \"veteran\" badge on your profile and the leaderboard.": "Profilinde ve liderlik tablosunda \"gazi\" rozeti.",
  "A custom color for your rank badge ring.": "Rütbe rozetinin halkası için özel bir renk.",
  "A golden badge frame and a highlighted name in comments and the leaderboard.": "Rozette altın çerçeve ve yorumlarda/liderlik tablosunda vurgulanan isim.",
  "A small crown next to your name in the feed and leaderboard.": "Akışta ve liderlik tablosunda adının yanında küçük bir taç.",
  "A special avatar frame — and 25% off the subscription, once it exists.": "Özel bir avatar çerçevesi — ve abonelik var olduğunda %25 indirim.",
  "Add a short bio to your profile.": "Profiline kısa bir biyografi ekle.",
  "An animated glow around your profile card.": "Profil kartının etrafında animasyonlu bir parıltı.",
  "An exclusive app-wide color theme.": "Uygulama genelinde özel bir renk teması.",
  "Badge color": "Rozet rengi",
  "Bio": "Biyografi",
  "Choose a custom color for your rank badge.": "Rütbe rozetin için özel bir renk seç.",
  "Perks": "Ayrıcalıklar",
  "Pin 2 featured posts instead of 1.": "1 yerine 2 öne çıkan gönderi sabitle.",
  "Pin a featured post to your profile.": "Profiline öne çıkan bir gönderi sabitle.",
  "Pin as favorite PR": "Favori PR olarak sabitle",
  "Pin to profile": "Profile sabitle",
  "Pin your favorite PR to your profile.": "Favori PR'ını profiline sabitle.",
  "Pinned": "Sabitlendi",
  "Prestige": "Prestij",
  "Say something about yourself": "Kendinle ilgili bir şeyler yaz",
  "The most exclusive, animated badge frame — and 50% off the subscription, once it exists.": "Hepsinin en özel, animasyonlu rozet çerçevesi — ve abonelik var olduğunda %50 indirim.",
  "The start of your climb.": "Yükselişinin başlangıcı.",
  "Upload up to 6 photos per workout.": "Antrenman başına 6 fotoğrafa kadar yükle.",
  "Upload up to 8 photos per workout.": "Antrenman başına 8 fotoğrafa kadar yükle.",
  "Veteran": "Gazi",
  "Your comments get a highlighted background.": "Yorumların vurgulanmış bir arka plan alır.",
  "Your name gets an animated color gradient in the feed.": "Akışta adın animasyonlu bir renk geçişi alır.",
  "Your rank badge gets a subtle animated glow in the feed.": "Rütbe rozetin akışta hafif animasyonlu bir parıltı alır.",
}
