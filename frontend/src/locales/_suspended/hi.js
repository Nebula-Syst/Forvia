...
export default {
  ...
  'to install Forvia as a full-screen app.': 'से Forvia को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if Forvia is closed.': 'आराम टाइमर अलर्ट, Forvia बंद होने पर भी।',
  ...
  'A small file a friend imports into their own Forvia — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने Forvia में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload Forvia': 'Forvia फिर से लोड करें',
...
// --- password login / demo data (added 2026-08-24) ---
  "12 weeks of example workouts & weigh-ins, to see the app filled in": "ऐप को भरा हुआ देखने के लिए 12 हफ़्तों के उदाहरण वर्कआउट और वज़न प्रविष्टियाँ",
  "Account sign-in, sync across your devices, your own data.": "खाते से साइन-इन, आपके डिवाइसों में सिंक, आपका अपना डेटा।",
  "Activity": "गतिविधि",
  "Change username or password": "उपयोगकर्ता नाम या पासवर्ड बदलें",
  "Could not save": "सेव नहीं हो सका",
  "Create account": "खाता बनाएँ",
  "Demo": "डेमो",
  "Demo data loaded": "डेमो डेटा लोड हो गया",
  "Demo data reset": "डेमो डेटा रीसेट हो गया",
  "Enter your username and password": "अपना उपयोगकर्ता नाम और पासवर्ड डालें",
  "Example data, stored only in this browser — change anything you like.": "उदाहरण डेटा, केवल इस ब्राउज़र में सहेजा गया है — जो चाहें बदलें।",
  "Exercise": "व्यायाम",
  "Live demo — everything stays in this browser.": "लाइव डेमो — सब कुछ इसी ब्राउज़र में रहता है।",
  "Load": "लोड करें",
  "Load demo data": "डेमो डेटा लोड करें",
  "Load demo data?": "डेमो डेटा लोड करें?",
  "New password (min 8 characters)": "नया पासवर्ड (कम से कम 8 अक्षर)",
  "No exercises yet.": "अभी तक कोई व्यायाम नहीं।",
  "Password": "पासवर्ड",
  "Password (min 8 characters)": "पासवर्ड (कम से कम 8 अक्षर)",
  "Password must be at least 8 characters": "पासवर्ड में कम से कम 8 अक्षर होने चाहिए",
  "Password updated": "पासवर्ड अपडेट हो गया",
  "Puts the example plan, workouts and weigh-ins back the way they started.": "उदाहरण योजना, वर्कआउट और वज़न प्रविष्टियों को वापस शुरुआती स्थिति में ले जाता है।",
  "Replaces your current plan, workouts and body weight with a 12-week example history.": "आपकी मौजूदा योजना, वर्कआउट और शरीर के वज़न को 12 हफ़्तों के उदाहरण इतिहास से बदल देता है।",
  "Reset": "रीसेट करें",
  "Reset demo data": "डेमो डेटा रीसेट करें",
  "Reset demo data?": "डेमो डेटा रीसेट करें?",
  "Save changes": "बदलाव सेव करें",
  "Self-host it in a minute →": "एक मिनट में इसे खुद होस्ट करें →",
  "Self-host Forvia": "Forvia खुद होस्ट करें",
  "Sign in": "साइन इन करें",
  "Signed in as {0} — data syncs to this profile.": "{0} के रूप में साइन इन — डेटा इस प्रोफ़ाइल से सिंक होता है।",
  "Signs this profile out on every device, including this one. Sign in with your username and password again anytime.": "इस डिवाइस सहित सभी डिवाइस पर इस प्रोफ़ाइल को साइन आउट करता है। कभी भी अपने उपयोगकर्ता नाम और पासवर्ड से फिर से साइन इन करें।",
  "Start the demo": "डेमो शुरू करें",
  "Streak": "स्ट्रीक",
  "This demo runs entirely in your browser on example data — nothing is sent anywhere. Account sign-in and sync across your devices come with the Forvia server, which you get by self-hosting it.": "यह डेमो पूरी तरह से आपके ब्राउज़र में उदाहरण डेटा पर चलता है — कहीं कुछ नहीं भेजा जाता। खाते से साइन-इन और डिवाइसों में सिंक Forvia सर्वर के साथ मिलता है, जो आपको खुद होस्ट करने पर मिलता है।",
  "This week’s balance": "इस हफ़्ते का संतुलन",
  "Username": "उपयोगकर्ता नाम",
  "Username must be at least 3 characters": "उपयोगकर्ता नाम में कम से कम 3 अक्षर होने चाहिए",
  "You’re in the demo": "आप डेमो में हैं",
  "{0}/{1} this week": "इस हफ़्ते {0}/{1}",
// --- social (added 2026-08-25) ---
  ...
  "Lets other accounts on this instance follow you and see your workouts in Social.": "इस इंस्टेंस के अन्य खाते आपको फॉलो कर सकें और सोशल में आपके वर्कआउट देख सकें।",
  "No activity yet — follow someone in Discover to see their workouts here.": "अभी कोई गतिविधि नहीं — यहाँ वर्कआउट देखने के लिए खोजें में किसी को फॉलो करें।",
  "No comments yet.": "अभी कोई टिप्पणी नहीं।",
  "Nobody on this instance has made their profile public yet.": "इस इंस्टेंस पर अभी तक किसी ने अपनी प्रोफ़ाइल सार्वजनिक नहीं की है।",
  "Post": "पोस्ट करें",
  "Progress": "प्रगति",
  "Public profile": "सार्वजनिक प्रोफ़ाइल",
  "Resume workout": "वर्कआउट जारी रखें",
  "See what people you follow are training": "देखें आप जिन्हें फॉलो करते हैं वे क्या कर रहे हैं",
  "Sign in to follow people and see their activity — guest profiles stay local to this device.": "लोगों को फॉलो करने और उनकी गतिविधि देखने के लिए साइन इन करें — गेस्ट प्रोफ़ाइल केवल इसी डिवाइस पर रहती हैं।",
  "Social": "सोशल",
  "Write a comment…": "टिप्पणी लिखें…",
  "You": "आप",
  "{0} comments": "{0} टिप्पणियाँ",
  "{0} this week": "इस हफ़्ते {0}",
  "{0} · {1}": "{0} · {1}",
// --- social posts: title, description, photos (added 2026-08-25) ---
  "Add a description (optional)": "विवरण जोड़ें (वैकल्पिक)",
  "Copied to clipboard": "क्लिपबोर्ड पर कॉपी किया गया",
  "Could not copy": "कॉपी नहीं हो सका",
  "Could not upload image": "इमेज अपलोड नहीं हो सकी",
  "Followers": "फॉलोअर्स",
  "Name this workout": "इस वर्कआउट को नाम दें",
  "Recent activity": "हाल की गतिविधि",
  "Records": "रिकॉर्ड",
  "Share": "शेयर करें",
  "Show less": "कम दिखाएं",
  "Show {0} more exercises": "{0} और व्यायाम दिखाएं",
  "Suggested athletes": "सुझाए गए एथलीट",
  "Title & photos": "शीर्षक और फ़ोटो",
  "Previous": "पिछला",
  "For you": "आपके लिए",
  "View your profile": "अपनी प्रोफ़ाइल देखें",
  "{0} is too large — max {1} MB": "{0} बहुत बड़ी है — अधिकतम {1} MB",
  "No public workouts yet.": "अभी तक कोई सार्वजनिक वर्कआउट नहीं।",
  "This profile isn't available.": "यह प्रोफ़ाइल उपलब्ध नहीं है।",
  "Level {0}": "स्तर {0}",
  "Today's tasks": "आज के कार्य",
  "Prestige {0}": "प्रेस्टीज {0}",
  "Tiers": "श्रेणियाँ",
  "{0} / {1} XP": "{0} / {1} XP",
  "{0} XP to next level": "अगले स्तर तक {0} XP",
  "Rank": "रैंक",
  "Prestige levels": "प्रेस्टीज स्तर",
  "Locked": "लॉक्ड",
  "A \"veteran\" badge on your profile and the leaderboard.": "आपकी प्रोफ़ाइल और लीडरबोर्ड पर \"वेटरन\" बैज।",
  "A custom color for your rank badge ring.": "आपके रैंक बैज रिंग के लिए कस्टम रंग।",
  "A golden badge frame and a highlighted name in comments and the leaderboard.": "बैज पर सुनहरा फ्रेम और कमेंट्स व लीडरबोर्ड में हाइलाइट किया गया नाम।",
  "A small crown next to your name in the feed and leaderboard.": "फ़ीड और लीडरबोर्ड में आपके नाम के बगल में एक छोटा मुकुट।",
  "A special avatar frame — and 25% off the subscription, once it exists.": "एक खास अवतार फ्रेम — और सब्सक्रिप्शन आने पर 25% छूट।",
  "Add a short bio to your profile.": "अपनी प्रोफ़ाइल में एक छोटा बायो जोड़ें।",
  "An animated glow around your profile card.": "आपके प्रोफ़ाइल कार्ड के चारों ओर एक एनिमेटेड चमक।",
  "An exclusive app-wide color theme.": "पूरे ऐप के लिए एक एक्सक्लूसिव कलर थीम।",
  "Badge color": "बैज का रंग",
  "Bio": "बायो",
  "Choose a custom color for your rank badge.": "अपने रैंक बैज के लिए कस्टम रंग चुनें।",
  "Perks": "विशेषाधिकार",
  "Pin 2 featured posts instead of 1.": "1 की जगह 2 फ़ीचर्ड पोस्ट पिन करें।",
  "Pin a featured post to your profile.": "अपनी प्रोफ़ाइल पर एक फ़ीचर्ड पोस्ट पिन करें।",
  "Pin as favorite PR": "पसंदीदा PR के रूप में पिन करें",
  "Pin to profile": "प्रोफ़ाइल पर पिन करें",
  "Pin your favorite PR to your profile.": "अपना पसंदीदा PR अपनी प्रोफ़ाइल पर पिन करें।",
  "Pinned": "पिन किया गया",
  "Prestige": "प्रेस्टीज",
  "Say something about yourself": "अपने बारे में कुछ बताएं",
  "The most exclusive, animated badge frame — and 50% off the subscription, once it exists.": "सबसे एक्सक्लूसिव, एनिमेटेड बैज फ्रेम — और सब्सक्रिप्शन आने पर 50% छूट।",
  "The start of your climb.": "आपकी चढ़ाई की शुरुआत।",
  "Upload up to 6 photos per workout.": "प्रति वर्कआउट 6 फ़ोटो तक अपलोड करें।",
  "Upload up to 8 photos per workout.": "प्रति वर्कआउट 8 फ़ोटो तक अपलोड करें।",
  "Veteran": "वेटरन",
  "Your comments get a highlighted background.": "आपके कमेंट्स को हाइलाइट किया गया बैकग्राउंड मिलता है।",
  "Your name gets an animated color gradient in the feed.": "फ़ीड में आपके नाम को एनिमेटेड कलर ग्रेडिएंट मिलता है।",
  "Your rank badge gets a subtle animated glow in the feed.": "फ़ीड में आपके रैंक बैज को हल्की एनिमेटेड चमक मिलती है।",
}
