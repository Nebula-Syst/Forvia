...
export default {
  ...
  'to install Forvia as a full-screen app.': '하면 Forvia을 전체 화면 앱으로 설치할 수 있어요.',
  ...
  'Rest-timer alerts, even if Forvia is closed.': 'Forvia이 닫혀 있어도 휴식 타이머 알림을 받아요.',
  ...
  'A small file a friend imports into their own Forvia — routines only, none of your workouts or weigh-ins.': '친구가 자신의 Forvia으로 가져올 수 있는 작은 파일 — 루틴만 포함되며 운동 기록이나 체중은 포함되지 않습니다.',
...
// --- password login / demo data (added 2026-08-24) ---
  "12 weeks of example workouts & weigh-ins, to see the app filled in": "앱이 채워진 모습을 보려면 12주 분량의 예시 운동 및 체중 기록",
  "Account sign-in, sync across your devices, your own data.": "계정 로그인, 기기 간 동기화, 나만의 데이터.",
  "Activity": "활동",
  "Change username or password": "사용자 이름 또는 비밀번호 변경",
  "Could not save": "저장할 수 없습니다",
  "Create account": "계정 만들기",
  "Demo": "데모",
  "Demo data loaded": "데모 데이터가 로드되었습니다",
  "Demo data reset": "데모 데이터가 초기화되었습니다",
  "Enter your username and password": "사용자 이름과 비밀번호를 입력하세요",
  "Example data, stored only in this browser — change anything you like.": "예시 데이터이며 이 브라우저에만 저장됩니다 — 자유롭게 바꿔보세요.",
  "Exercise": "운동",
  "Live demo — everything stays in this browser.": "실시간 데모 — 모든 데이터는 이 브라우저에만 남습니다.",
  "Load": "불러오기",
  "Load demo data": "데모 데이터 불러오기",
  "Load demo data?": "데모 데이터를 불러올까요?",
  "New password (min 8 characters)": "새 비밀번호 (최소 8자)",
  ...
  "Replaces your current plan, workouts and body weight with a 12-week example history.": "현재 계획, 운동 기록, 체중을 12주 분량의 예시 기록으로 대체합니다.",
  "Reset": "초기화",
  "Reset demo data": "데모 데이터 초기화",
  "Reset demo data?": "데모 데이터를 초기화할까요?",
  "Save changes": "변경사항 저장",
  "Self-host it in a minute →": "1분 만에 직접 호스팅하기 →",
  "Self-host Forvia": "Forvia 직접 호스팅하기",
  "Sign in": "로그인",
  "Signed in as {0} — data syncs to this profile.": "{0}(으)로 로그인됨 — 데이터가 이 프로필과 동기화됩니다.",
  "Signs this profile out on every device, including this one. Sign in with your username and password again anytime.": "이 기기를 포함해 모든 기기에서 이 프로필을 로그아웃합니다. 언제든 사용자 이름과 비밀번호로 다시 로그인할 수 있습니다.",
  "Start the demo": "데모 시작하기",
  "Streak": "연속 기록",
  "This demo runs entirely in your browser on example data — nothing is sent anywhere. Account sign-in and sync across your devices come with the Forvia server, which you get by self-hosting it.": "이 데모는 예시 데이터를 사용해 브라우저에서만 실행됩니다 — 어디로도 전송되지 않습니다. 계정 로그인과 기기 간 동기화는 직접 호스팅하는 Forvia 서버에서 제공됩니다.",
  "This week’s balance": "이번 주 밸런스",
  "Username": "사용자 이름",
  "Username must be at least 3 characters": "사용자 이름은 최소 3자 이상이어야 합니다",
  "You’re in the demo": "데모를 이용 중입니다",
  "{0}/{1} this week": "이번 주 {0}/{1}",
// --- social (added 2026-08-25) ---
  "Comments": "댓글",
  "Could not load": "불러올 수 없습니다",
  "Discover": "둘러보기",
  "Feed": "피드",
  "Follow": "팔로우",
  "Following": "팔로잉",
  "Leaderboard": "리더보드",
  "Lets other accounts on this instance follow you and see your workouts in Social.": "이 인스턴스의 다른 계정이 나를 팔로우하고 소셜에서 내 운동을 볼 수 있게 합니다.",
  "No activity yet — follow someone in Discover to see their workouts here.": "아직 활동이 없습니다 — 둘러보기에서 누군가를 팔로우하면 여기서 운동을 볼 수 있어요.",
  "No comments yet.": "아직 댓글이 없습니다.",
  "Nobody on this instance has made their profile public yet.": "이 인스턴스에서 아직 프로필을 공개한 사람이 없습니다.",
  "Post": "게시",
  "Progress": "진행 상황",
  "Public profile": "공개 프로필",
  "Resume workout": "운동 이어하기",
  "See what people you follow are training": "팔로우하는 사람들이 어떤 운동을 하는지 확인하세요",
  "Sign in to follow people and see their activity — guest profiles stay local to this device.": "다른 사람을 팔로우하고 활동을 보려면 로그인하세요 — 게스트 프로필은 이 기기에만 저장됩니다.",
  "Social": "소셜",
...
// --- social posts: title, description, photos (added 2026-08-25) ---
  "Add a description (optional)": "설명 추가 (선택 사항)",
  "Copied to clipboard": "클립보드에 복사됨",
  "Could not copy": "복사할 수 없습니다",
  "Could not upload image": "이미지를 업로드할 수 없습니다",
  "Followers": "팔로워",
  "Name this workout": "이 운동에 이름 붙이기",
  "Recent activity": "최근 활동",
  "Records": "기록",
  "Share": "공유",
  "Show less": "간략히 보기",
  "Show {0} more exercises": "운동 {0}개 더 보기",
  "Suggested athletes": "추천 운동선수",
  "Title & photos": "제목 및 사진",
  "Previous": "이전",
  "For you": "추천",
  "View your profile": "내 프로필 보기",
  "{0} is too large — max {1} MB": "{0}이(가) 너무 큽니다 — 최대 {1}MB",
  "No public workouts yet.": "아직 공개된 운동이 없습니다.",
  "This profile isn't available.": "이 프로필을 사용할 수 없습니다.",
  "Level {0}": "레벨 {0}",
  "Today's tasks": "오늘의 과제",
  "Prestige {0}": "프레스티지 {0}",
  "Tiers": "티어",
  "{0} / {1} XP": "{0} / {1} XP",
  "{0} XP to next level": "다음 레벨까지 {0} XP",
  "Rank": "랭크",
  "Prestige levels": "프레스티지 레벨",
  "Locked": "잠김",
  "A \"veteran\" badge on your profile and the leaderboard.": "프로필과 순위표에 표시되는 \"베테랑\" 배지.",
  "A custom color for your rank badge ring.": "랭크 배지 테두리에 사용할 나만의 색상.",
  "A golden badge frame and a highlighted name in comments and the leaderboard.": "배지에 골드 테두리, 댓글과 순위표에서 강조되는 이름.",
  "A small crown next to your name in the feed and leaderboard.": "피드와 순위표에서 이름 옆에 작은 왕관 표시.",
  "A special avatar frame — and 25% off the subscription, once it exists.": "특별한 아바타 테두리 — 그리고 구독이 생기면 25% 할인.",
  "Add a short bio to your profile.": "프로필에 짧은 소개글 추가.",
  "An animated glow around your profile card.": "프로필 카드 주위에 애니메이션 광채 효과.",
  "An exclusive app-wide color theme.": "앱 전체에 적용되는 전용 컬러 테마.",
  "Badge color": "배지 색상",
  "Bio": "소개글",
  "Choose a custom color for your rank badge.": "랭크 배지에 사용할 나만의 색상 선택.",
  "Perks": "혜택",
  "Pin 2 featured posts instead of 1.": "대표 게시물을 1개 대신 2개까지 고정.",
  "Pin a featured post to your profile.": "프로필에 대표 게시물 고정.",
  "Pin as favorite PR": "즐겨찾는 PR로 고정",
  "Pin to profile": "프로필에 고정",
  "Pin your favorite PR to your profile.": "즐겨찾는 PR을 프로필에 고정.",
  "Pinned": "고정됨",
  "Prestige": "프레스티지",
  "Say something about yourself": "자신에 대해 소개해 보세요",
  "The most exclusive, animated badge frame — and 50% off the subscription, once it exists.": "가장 특별하고 화려한 애니메이션 배지 테두리 — 그리고 구독이 생기면 50% 할인.",
  "The start of your climb.": "당신의 여정이 시작되는 곳.",
  "Upload up to 6 photos per workout.": "운동당 사진 최대 6장 업로드.",
  "Upload up to 8 photos per workout.": "운동당 사진 최대 8장 업로드.",
  "Veteran": "베테랑",
  "Your comments get a highlighted background.": "댓글에 강조 배경이 적용됩니다.",
  "Your name gets an animated color gradient in the feed.": "피드에서 이름에 애니메이션 그라데이션이 적용됩니다.",
  "Your rank badge gets a subtle animated glow in the feed.": "피드에서 랭크 배지에 은은한 애니메이션 광채가 적용됩니다.",
}
