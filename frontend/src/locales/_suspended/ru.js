...
export default {
  ...
  'to install Forvia as a full-screen app.': 'чтобы установить Forvia как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if Forvia is closed.': 'Оповещения таймера отдыха, даже если Forvia закрыт.',
  ...
  'A small file a friend imports into their own Forvia — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Forvia — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload Forvia': 'Перезагрузить Forvia',
...
// --- password login / demo data (added 2026-08-24) ---
  "12 weeks of example workouts & weigh-ins, to see the app filled in": "12 недель примерных тренировок и записей веса — чтобы увидеть приложение заполненным",
  "Account sign-in, sync across your devices, your own data.": "Вход по аккаунту, синхронизация между устройствами, только ваши данные.",
  "Activity": "Активность",
  "Change username or password": "Изменить имя пользователя или пароль",
  "Could not save": "Не удалось сохранить",
  "Create account": "Создать аккаунт",
  "Demo": "Демо",
  "Demo data loaded": "Демо-данные загружены",
  "Demo data reset": "Демо-данные сброшены",
  "Enter your username and password": "Введите имя пользователя и пароль",
  "Example data, stored only in this browser — change anything you like.": "Демонстрационные данные, хранятся только в этом браузере — меняйте, что хотите.",
  "Exercise": "Упражнение",
  "Live demo — everything stays in this browser.": "Живая демо-версия — всё остаётся в этом браузере.",
  "Load": "Загрузить",
  "Load demo data": "Загрузить демо-данные",
  "Load demo data?": "Загрузить демо-данные?",
  "New password (min 8 characters)": "Новый пароль (мин. 8 символов)",
  ...
  "Puts the example plan, workouts and weigh-ins back the way they started.": "Возвращает демонстрационный план, тренировки и записи веса к исходному состоянию.",
  "Replaces your current plan, workouts and body weight with a 12-week example history.": "Заменяет ваш текущий план, тренировки и вес тела на 12-недельную демонстрационную историю.",
  "Reset": "Сбросить",
  "Reset demo data": "Сбросить демо-данные",
  "Reset demo data?": "Сбросить демо-данные?",
  "Save changes": "Сохранить изменения",
  "Self-host it in a minute →": "Разверните на своём сервере за минуту →",
  "Self-host Forvia": "Развернуть Forvia на своём сервере",
  "Sign in": "Войти",
  "Signed in as {0} — data syncs to this profile.": "Вход выполнен как {0} — данные синхронизируются с этим профилем.",
  "Signs this profile out on every device, including this one. Sign in with your username and password again anytime.": "Завершает сеансы этого профиля на всех устройствах, включая это. Вы можете снова войти с именем пользователя и паролем в любое время.",
  "Start the demo": "Начать демо",
  "Streak": "Серия",
  "This demo runs entirely in your browser on example data — nothing is sent anywhere. Account sign-in and sync across your devices come with the Forvia server, which you get by self-hosting it.": "Эта демо-версия работает полностью в вашем браузере на примерных данных — никуда ничего не отправляется. Вход по аккаунту и синхронизация между устройствами доступны на сервере Forvia, который вы получаете, развернув его самостоятельно.",
  "This week’s balance": "Баланс за эту неделю",
  ...
  "{0}/{1} this week": "{0}/{1} на этой неделе",
// --- social (added 2026-08-25) ---
  ...
  "Leaderboard": "Рейтинг",
  "Lets other accounts on this instance follow you and see your workouts in Social.": "Позволяет другим аккаунтам на этом сервере подписываться на вас и видеть ваши тренировки в разделе «Соцсеть».",
  "No activity yet — follow someone in Discover to see their workouts here.": "Пока нет активности — подпишитесь на кого-нибудь в разделе «Обзор», чтобы видеть здесь его тренировки.",
  "No comments yet.": "Пока нет комментариев.",
  "Nobody on this instance has made their profile public yet.": "На этом сервере пока никто не сделал свой профиль публичным.",
  "Post": "Отправить",
  "Progress": "Прогресс",
  "Public profile": "Публичный профиль",
  "Resume workout": "Продолжить тренировку",
  "See what people you follow are training": "Смотрите, что тренируют те, на кого вы подписаны",
  "Sign in to follow people and see their activity — guest profiles stay local to this device.": "Войдите, чтобы подписываться на людей и видеть их активность — гостевые профили хранятся только на этом устройстве.",
  "Social": "Соцсеть",
...
// --- social posts: title, description, photos (added 2026-08-25) ---
  "Add a description (optional)": "Добавьте описание (необязательно)",
  "Copied to clipboard": "Скопировано в буфер обмена",
  "Could not copy": "Не удалось скопировать",
  "Could not upload image": "Не удалось загрузить изображение",
  "Followers": "Подписчики",
  "Name this workout": "Назовите эту тренировку",
  "Recent activity": "Недавняя активность",
  "Records": "Рекорды",
  "Share": "Поделиться",
  "Show less": "Показать меньше",
  "Show {0} more exercises": "Показать ещё {0} упражнений",
  "Suggested athletes": "Рекомендуемые спортсмены",
  "Title & photos": "Название и фото",
  "Previous": "Назад",
  "For you": "Для вас",
  "View your profile": "Посмотреть свой профиль",
  "{0} is too large — max {1} MB": "{0} слишком большой — макс. {1} МБ",
  "No public workouts yet.": "Пока нет публичных тренировок.",
  "This profile isn't available.": "Этот профиль недоступен.",
  "Level {0}": "Уровень {0}",
  "Today's tasks": "Задачи на сегодня",
  "Prestige {0}": "Престиж {0}",
  "Tiers": "Ранги",
  "{0} / {1} XP": "{0} / {1} XP",
  "{0} XP to next level": "{0} XP до следующего уровня",
  "Rank": "Ранг",
  "Prestige levels": "Уровни престижа",
  "Locked": "Заблокировано",
  "A \"veteran\" badge on your profile and the leaderboard.": "Значок «ветеран» в профиле и таблице лидеров.",
  "A custom color for your rank badge ring.": "Свой цвет для кольца значка ранга.",
  "A golden badge frame and a highlighted name in comments and the leaderboard.": "Золотая рамка значка и выделенное имя в комментариях и таблице лидеров.",
  "A small crown next to your name in the feed and leaderboard.": "Маленькая корона рядом с именем в ленте и таблице лидеров.",
  "A special avatar frame — and 25% off the subscription, once it exists.": "Особая рамка аватара — и скидка 25% на подписку, когда она появится.",
  "Add a short bio to your profile.": "Добавьте короткую биографию в профиль.",
  "An animated glow around your profile card.": "Анимированное свечение вокруг карточки профиля.",
  "An exclusive app-wide color theme.": "Эксклюзивная цветовая тема для всего приложения.",
  "Badge color": "Цвет значка",
  "Bio": "Био",
  "Choose a custom color for your rank badge.": "Выберите свой цвет для значка ранга.",
  "Perks": "Преимущества",
  "Pin 2 featured posts instead of 1.": "Закрепляйте 2 публикации вместо 1.",
  "Pin a featured post to your profile.": "Закрепите публикацию в профиле.",
  "Pin as favorite PR": "Закрепить как любимый рекорд",
  "Pin to profile": "Закрепить в профиле",
  "Pin your favorite PR to your profile.": "Закрепите свой любимый рекорд в профиле.",
  "Pinned": "Закреплено",
  "Prestige": "Престиж",
  "Say something about yourself": "Расскажите о себе",
  "The most exclusive, animated badge frame — and 50% off the subscription, once it exists.": "Самая эксклюзивная анимированная рамка значка — и скидка 50% на подписку, когда она появится.",
  "The start of your climb.": "Начало вашего восхождения.",
  "Upload up to 6 photos per workout.": "Загружайте до 6 фото за тренировку.",
  "Upload up to 8 photos per workout.": "Загружайте до 8 фото за тренировку.",
  "Veteran": "Ветеран",
  "Your comments get a highlighted background.": "Ваши комментарии получают выделенный фон.",
  "Your name gets an animated color gradient in the feed.": "Ваше имя получает анимированный цветовой градиент в ленте.",
  "Your rank badge gets a subtle animated glow in the feed.": "Ваш значок ранга получает лёгкое анимированное свечение в ленте.",
}
