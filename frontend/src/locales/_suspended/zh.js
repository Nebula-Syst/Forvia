...
export default {
  ...
  'to install Forvia as a full-screen app.': '即可将 Forvia 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if Forvia is closed.': '休息计时提醒，即使 Forvia 已关闭。',
  ...
  'A small file a friend imports into their own Forvia — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 Forvia——只有训练日，不包含你的训练记录或体重。',
...
// --- password login / demo data (added 2026-08-24) ---
  "12 weeks of example workouts & weigh-ins, to see the app filled in": "12周示例训练和体重记录，让你看看应用填满后的样子",
  "Account sign-in, sync across your devices, your own data.": "账户登录，跨设备同步，数据完全属于你。",
  "Activity": "活动",
  "Change username or password": "修改用户名或密码",
  "Could not save": "无法保存",
  "Create account": "创建账户",
  "Demo": "演示",
  "Demo data loaded": "演示数据已加载",
  ...
  "Exercise": "动作",
  "Live demo — everything stays in this browser.": "实时演示——所有内容都只保存在此浏览器中。",
  "Load": "加载",
  "Load demo data": "加载演示数据",
  "Load demo data?": "要加载演示数据吗？",
  "New password (min 8 characters)": "新密码（至少8个字符）",
  ...
  "Puts the example plan, workouts and weigh-ins back the way they started.": "将示例计划、训练和体重记录恢复为初始状态。",
  "Replaces your current plan, workouts and body weight with a 12-week example history.": "用12周的示例历史记录替换你当前的计划、训练和体重数据。",
  "Reset": "重置",
  "Reset demo data": "重置演示数据",
  "Reset demo data?": "要重置演示数据吗？",
  "Save changes": "保存更改",
  "Self-host it in a minute →": "一分钟内自行部署 →",
  "Self-host Forvia": "自行部署 Forvia",
  "Sign in": "登录",
  "Signed in as {0} — data syncs to this profile.": "已以 {0} 身份登录——数据同步到此档案。",
  "Signs this profile out on every device, including this one. Sign in with your username and password again anytime.": "在所有设备（包括此设备）上退出此档案的登录。你可以随时用用户名和密码重新登录。",
  "Start the demo": "开始演示",
  "Streak": "连续天数",
  "This demo runs entirely in your browser on example data — nothing is sent anywhere. Account sign-in and sync across your devices come with the Forvia server, which you get by self-hosting it.": "此演示完全在你的浏览器中使用示例数据运行——不会向任何地方发送任何内容。账户登录和跨设备同步需要通过自行部署 Forvia 服务器获得。",
  "This week’s balance": "本周训练平衡",
  "Username": "用户名",
  "Username must be at least 3 characters": "用户名至少需要3个字符",
  "You’re in the demo": "你正在体验演示版",
  "{0}/{1} this week": "本周 {0}/{1}",
// --- social (added 2026-08-25) ---
  ...
  "Following": "已关注",
  "Leaderboard": "排行榜",
  "Lets other accounts on this instance follow you and see your workouts in Social.": "允许本实例上的其他账号关注你，并在「社交」中查看你的训练。",
  "No activity yet — follow someone in Discover to see their workouts here.": "暂无动态 — 在「发现」中关注某人，即可在此查看他们的训练。",
  "No comments yet.": "暂无评论。",
  "Nobody on this instance has made their profile public yet.": "本实例上还没有人公开自己的资料。",
  "Post": "发布",
  "Progress": "进度",
  "Public profile": "公开资料",
  "Resume workout": "继续训练",
  "See what people you follow are training": "看看你关注的人在练什么",
  "Sign in to follow people and see their activity — guest profiles stay local to this device.": "登录后即可关注他人并查看他们的动态 — 访客资料仅保存在本设备。",
  "Social": "社交",
  "Write a comment…": "写评论…",
  "You": "你",
  "{0} comments": "{0} 条评论",
...
// --- social posts: title, description, photos (added 2026-08-25) ---
  ...
  "Followers": "粉丝",
  "Name this workout": "给这次训练起个名字",
  "Recent activity": "最近动态",
  "Records": "纪录",
  "Share": "分享",
  "Show less": "收起",
  "Show {0} more exercises": "显示另外 {0} 个动作",
  "Suggested athletes": "推荐运动员",
  "Title & photos": "标题和照片",
  "Previous": "上一个",
  "For you": "为你推荐",
  "View your profile": "查看你的资料",
  "{0} is too large — max {1} MB": "{0} 太大 — 最大 {1} MB",
  "No public workouts yet.": "还没有公开的训练。",
  "This profile isn't available.": "该资料不可用。",
  "Level {0}": "等级 {0}",
  "Today's tasks": "今日任务",
  "Prestige {0}": "威望 {0}",
  "Tiers": "段位",
  "{0} / {1} XP": "{0} / {1} XP",
  "{0} XP to next level": "距下一级还需 {0} XP",
  "Rank": "等级",
  "Prestige levels": "威望等级",
  "Locked": "已锁定",
  "A \"veteran\" badge on your profile and the leaderboard.": "个人资料和排行榜上的“资深”徽章。",
  "A custom color for your rank badge ring.": "为你的段位徽章圆环选择专属颜色。",
  "A golden badge frame and a highlighted name in comments and the leaderboard.": "徽章金色边框，评论和排行榜中的名字高亮显示。",
  "A small crown next to your name in the feed and leaderboard.": "动态和排行榜中名字旁的小皇冠。",
  "A special avatar frame — and 25% off the subscription, once it exists.": "特殊头像边框——以及订阅功能上线后享受 25% 折扣。",
  "Add a short bio to your profile.": "在个人资料中添加简短简介。",
  "An animated glow around your profile card.": "个人资料卡周围的动态光效。",
  "An exclusive app-wide color theme.": "全应用专属配色主题。",
  "Badge color": "徽章颜色",
  "Bio": "简介",
  "Choose a custom color for your rank badge.": "为你的段位徽章选择专属颜色。",
  "Perks": "特权",
  "Pin 2 featured posts instead of 1.": "置顶 2 篇精选动态，而不是 1 篇。",
  "Pin a featured post to your profile.": "在个人资料置顶一篇精选动态。",
  "Pin as favorite PR": "置顶为最爱纪录",
  "Pin to profile": "置顶到个人资料",
  "Pin your favorite PR to your profile.": "将你最爱的个人纪录置顶到个人资料。",
  "Pinned": "已置顶",
  "Prestige": "威望",
  "Say something about yourself": "介绍一下自己",
  "The most exclusive, animated badge frame — and 50% off the subscription, once it exists.": "最尊贵的动态徽章边框——以及订阅功能上线后享受 50% 折扣。",
  "The start of your climb.": "你攀登之路的起点。",
  "Upload up to 6 photos per workout.": "每次训练最多上传 6 张照片。",
  "Upload up to 8 photos per workout.": "每次训练最多上传 8 张照片。",
  "Veteran": "资深",
  "Your comments get a highlighted background.": "你的评论会带有高亮背景。",
  "Your name gets an animated color gradient in the feed.": "你的名字在动态中会有动态渐变色。",
  "Your rank badge gets a subtle animated glow in the feed.": "你的段位徽章在动态中会有微妙的动态光效。",
}
