...
// --- password login / demo data (added 2026-08-24) ---
  ...
  "Streak": "연속 기록",
  "This demo runs entirely in your browser on example data — nothing is sent anywhere. Account sign-in and sync across your devices come with the openGym server, which you get by self-hosting it.": "이 데모는 예시 데이터를 사용해 브라우저에서만 실행됩니다 — 어디로도 전송되지 않습니다. 계정 로그인과 기기 간 동기화는 직접 호스팅하는 openGym 서버에서 제공됩니다.",
