...
// Delays span 0-80ms (was 0-830ms) — the lime bars used to be well into drawing themselves
// before the white F even started (570-830ms in), which on its own read as a stray green flash
// rather than one cohesive reveal (same issue, same fix, as forvia-mobile's native splash).
// Kept close together instead of dropped to zero across the board so it still reads as
// "drawing itself", just without the color-order gap.
const LIME_PATHS = [
  ...
  { d: 'M217 1804 c-4 -4 -7 -124 -7 -266 l0 -258 100 0 100 0 -2 263 -3 262 -90 3 c-50 1 -94 0 -98 -4z', delay: 40 },
  { d: 'M2770 1545 l0 -265 100 0 100 0 -2 263 -3 262 -97 3 -98 3 0 -266z', delay: 40 },
  { d: 'M1220 1252 c-96 -92 -238 -226 -315 -299 l-140 -132 215 -1 215 0 310 286 c171 157 317 292 325 300 12 12 -16 14 -210 14 l-225 -1 -175 -167z', delay: 80 },
]
const INK_PATHS = [
  { d: 'M1130 2024 l-360 -357 0 -143 0 -144 48 0 47 1 338 334 339 335 416 0 417 0 158 158 c86 86 157 161 157 165 0 4 -270 7 -600 7 l-600 0 -360 -356z', delay: 100 },
  { d: 'M1377 1672 c-75 -75 -137 -139 -137 -142 0 -3 187 -6 416 -7 l417 -2 66 62 c126 117 221 212 221 219 0 5 -190 8 -423 8 l-422 0 -138 -138z', delay: 130 },
]
