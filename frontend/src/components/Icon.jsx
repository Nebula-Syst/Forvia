...
const ACHIEVEMENT = {
  ...
  sliders: <><path d="M3.4 7.4h17.2M3.4 12h17.2M3.4 16.6h17.2" /><circle cx="9" cy="7.4" r="2" fill="currentColor" stroke="none" /><circle cx="15" cy="12" r="2" fill="currentColor" stroke="none" /><circle cx="11" cy="16.6" r="2" fill="currentColor" stroke="none" /></>,
...
const ACTIONS = {
  ...
  phone: <path d="M8.4 3.6H5.7A1.7 1.7 0 0 0 4 5.5c.4 6.6 5.7 12 12.4 12.5a1.7 1.7 0 0 0 1.8-1.7v-2.6l-3.9-1.5-1.3 1.5a13.5 13.5 0 0 1-5.6-5.6l1.5-1.3Z" />,
...
const OBJECTS = {
  ...
  pin: <><path d="M12 21.2c-4.2-4.1-6.8-7.7-6.8-10.8a6.8 6.8 0 0 1 13.6 0c0 3.1-2.6 6.7-6.8 10.8Z" /><circle cx="12" cy="10.2" r="2.3" /></>,
  crosshair: <><circle cx="12" cy="12" r="7.4" /><path d="M12 3v3M12 18v3M3 12h3M18 12h3" /></>,
