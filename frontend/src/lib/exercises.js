...
// current document's directory, so on the one two-segment route in the app, /routines/r/:id,
// every request went to /routines/r/img/… and 404'd — and nginx's extension block has no
