...
export const coachAddMember = (boxId, userId) => api('/api/coach/box/member/add', { method: 'POST', body: JSON.stringify({ boxId, userId }) })
...
export const coachBoxPlans = boxId => api('/api/coach/box/plans?boxId=' + encodeURIComponent(boxId)).then(r => r.plans)
export const coachCreatePlan = (boxId, fields) => api('/api/coach/box/plans', { method: 'POST', body: JSON.stringify({ boxId, ...fields }) }).then(r => r.plan)
export const coachUpdatePlan = (boxId, id, fields) => api('/api/coach/box/plans/update', { method: 'POST', body: JSON.stringify({ boxId, id, ...fields }) }).then(r => r.plan)
export const coachDeletePlan = (boxId, id) => api('/api/coach/box/plans/delete', { method: 'POST', body: JSON.stringify({ boxId, id }) })
export const coachAssignPlan = (boxId, athleteId, planId) => api('/api/coach/box/member/plan', { method: 'POST', body: JSON.stringify({ boxId, athleteId, planId }) })
...
export const coachSetClassWod = (boxId, sessionId, wod) => api('/api/coach/box/classes/wod', { method: 'POST', body: JSON.stringify({ boxId, sessionId, wod }) }).then(r => r.wod)
...
export const coachCreateWodTemplate = (boxId, name, wod) => api('/api/coach/box/wod-templates', { method: 'POST', body: JSON.stringify({ boxId, name, wod }) }).then(r => r.template)
export const coachApplyWodTemplate = (boxId, id, sessionId) => api('/api/coach/box/wod-templates/apply', { method: 'POST', body: JSON.stringify({ boxId, id, sessionId }) }).then(r => r.wod)
...
export const boxClasses = (boxId, from, to) => api('/api/box/classes?boxId=' + encodeURIComponent(boxId) + '&from=' + from + '&to=' + to)
