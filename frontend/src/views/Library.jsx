...
import { fmtNum, normalizeSearch } from '../lib/format.js'
...
export default function Library() {
  ...
  const base = allExercises(S).filter(e => (!bp || e.bp === bp) && (!ql || normalizeSearch(e.n).includes(ql) || normalizeSearch(nameFor(e)).includes(ql) || e.tg.includes(ql) || e.eq.includes(ql) || normalizeSearch(e.desc).includes(ql)))
